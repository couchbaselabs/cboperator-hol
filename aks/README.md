...
## Create Couchbase Operator Role
...
- Now run the following command to assign the operator role to the service account.
	...
	```
	kubectl create rolebinding couchbase-operator --role couchbase-operator --serviceaccount \
	workshop:couchbase-operator --namespace workshop
	```
