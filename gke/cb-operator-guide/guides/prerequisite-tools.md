...
| NAME              | VALUE |
| --------------------- | ----------- |
|AWS Access Key ID	|AKIAIYMEQW3GSYNZVTTA|
|AWS Secret Access Key|	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|
...
AWS Access Key ID [none]: AKIAIYMEQW3GSYNZVTTA
AWS Secret Access Key [none]: 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
